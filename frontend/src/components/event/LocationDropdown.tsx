    ...
    <div className="relative" ref={dropdownRef}>
      <div className="relative">
        <input
          ...
          className="w-full px-3 py-2 pr-10 text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
